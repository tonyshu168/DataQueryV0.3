...
$sql = "select * from products where productName like '$productName' AND channelNum like '$channelNum'
    ...
    AND effectiveDate like '$endDate'";
...
if($endDate != '%' and $effectiveDate != '%'){
    ...
    select did from products where productName like '$productName' AND channelNum like '$channelNum'
        AND company like '$company' AND cooperateType like '$cooperateType')";
