...
if(empty($adPlatform)){$adPlatform = null;}
...
$sql = "insert into products value(null,null,0, '$productName','$channelName','$company','$compAbbreviation','$cooperateType',$price,0,$effectiveDate,$endDate)";
